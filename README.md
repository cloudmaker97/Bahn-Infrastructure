...
Frontend-Entwicklung mit Hot-Reload: Server mit festem Port starten (`PORT=8000 npm start`),
dann `npm run dev:web` (Next-Dev-Server auf Port 3000, proxied `/api` und `/data` auf
